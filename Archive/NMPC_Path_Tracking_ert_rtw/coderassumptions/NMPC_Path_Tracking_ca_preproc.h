...
#ifndef NMPC_PATH_TRACKING_CA_PREPROC_H
#define NMPC_PATH_TRACKING_CA_PREPROC_H
...
#endif                                 /* NMPC_PATH_TRACKING_CA_PREPROC_H */
