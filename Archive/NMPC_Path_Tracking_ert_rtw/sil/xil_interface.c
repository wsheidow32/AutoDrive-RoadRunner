 ...
 *
 * SIL generated interface for code: "NMPC_Path_Tracking"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.current_position
            [0]);
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.yaw_rate);
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.psi);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.vx);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.vy);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.x_path[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 100 * sizeof
            (real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.y_path[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 100 * sizeof
            (real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.curvature[0]);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 100 * sizeof
            (real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.v_max);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_U.PredictionHorizon);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_Y.Out1);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_Y.accel);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_Y.deccel);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_Y.distances[0]);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 100 * sizeof(real_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }

        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_Y.Steer);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(NMPC_Path_Tracking_Y.distances[0]);
          xil_fcnid0_task1_y[tableIdx].memUnitLength = 100 * sizeof(real_T);
          xil_fcnid0_task1_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
