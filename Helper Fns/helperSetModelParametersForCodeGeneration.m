...
paramNameValueDescription = {...
    'SystemTargetFile', 'rsim.tlc', 'Code Generation>System target file';
    'TargetLang', 'C', 'Code Generation>Language';
    'SolverType', 'Variable-step', 'Solver>Type';
    'Solver', 'ode15s','Solver Name';
    ...
    'BuildConfiguration', 'Faster Builds', 'Code Generation>Build configuration';
